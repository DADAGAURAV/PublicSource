//vexternal offsets updated by liva#4838
...
namespace offsets {
	...
	std::ptrdiff_t local_player_controller = 0x38; // local_player + local_player_controller // TYPE=uintptr_t
	...
	constexpr uintptr_t last_render_time = 0x37C; // mesh_component + last_render_time // TYPE=float
	constexpr uintptr_t last_submit_time = 0x378; // mesh_component + last_submit_time // TYPE=float
